	...
	return (
		<div className="flex flex-col bg-white items-center justify-center">
			<div className="w-full pt-20">
				<img src={prakTopBg} className="w-full h-auto object-cover" alt="Background" />
			</div>
			<div className="flex flex-col gap-16 w-full md:w-2/3 p-4 md:p-8 py-12">
				...
				<div className="grid md:grid-cols-2 gap-6">
					<div className="bg-gray-50 animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
					...
					<div className="bg-gray-50 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
						<div className="flex items-start gap-3 mb-4">
							<span className="text-4xl">⏰</span>
				...
				>
					...
					<ul className="space-y-3 text-lg text-gray-700">
						...
						<li className="flex items-start gap-3">
							<span className="text-pink-600 mt-1">•</span>
							<span>
								Intakegesprek of eerste kennismaking kan meer tijd in beslag nemen
							</span>
						</li>
					</ul>
				</div>
				<div className="bg-gray-50 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
					<div className="flex items-start gap-4 mb-4">
						<span className="text-4xl">💶</span>
